...
public class SortCompare { // 用来比较两个排序算法的运行时间
...
//        else if (alg.equals("Bubbleble"))          Bubble.sort(a);
    ...
    public static void main(String[] args) {// java SortCompare Insertion Selection 1000 100
        String alg1 = args[0];
        String alg2 = args[1];
